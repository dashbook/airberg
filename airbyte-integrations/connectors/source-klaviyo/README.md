...
```
{
  "api_key": "klaviyo_secret_api_key",
...
| --- | --- | --- | --- | --- |
|api_key |string||null|Klaviyo API Key. See our <a href="https://docs.airbyte.com/integrations/sources/klaviyo">docs</a> if you need help finding this key.|
