...
|credentials.0.client_id|string||null|The API ID of the SmartSheets developer application.|
|credentials.0.client_secret|string||null|The API Secret the SmartSheets developer application.|
