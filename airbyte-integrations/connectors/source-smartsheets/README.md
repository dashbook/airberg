...
```json
{
  ...
  "metadata_fields": ["sheetcreatedAt", "sheetid"]
}
```
...
| --- | --- | --- | --- | --- |
|spreadsheet_id |string||null|The spreadsheet ID. Find it by opening the spreadsheet then navigating to File > Properties|
|start_datetime |string||2020-01-01T00:00:00+00:00|Only rows modified after this date/time will be replicated. This should be an ISO 8601 string, for instance: `2000-01-01T13:00:00`|
|metadata_fields |array||null|A List of available columns which metadata can be pulled from.|
|credentials.auth_type 0|string|oauth2.0|null||
|credentials.client_id 0|string||null|The API ID of the SmartSheets developer application.|
|credentials.client_secret 0|string||null|The API Secret the SmartSheets developer application.|
