...
| --- | --- | --- | --- | --- |
|MessageFormat|object||null|The serialization used based on this |
...
|subscription|object||null|You can choose to manually assign a list of partitions, or subscribe to all topics matching specified pattern to get dynamically assigned partitions.|
...
|protocol|object||null|The Protocol used to communicate with brokers.|
